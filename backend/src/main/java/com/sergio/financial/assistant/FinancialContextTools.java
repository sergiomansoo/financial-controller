...
public class FinancialContextTools {
    ...
    private JsonNode monthlyDashboard(Long userId, YearMonth selectedMonth, JsonNode arguments) {
        ...
        return objectMapper.valueToTree(dashboards.dashboard(userId, month, DashboardFilter.BOTH));
    }
    ...
    private JsonNode compareMonthlyTotals(Long userId, YearMonth selectedMonth, JsonNode arguments) {
        ...
        DashboardService.DashboardResponse currentDashboard = dashboards.dashboard(userId, month, DashboardFilter.BOTH);
        DashboardService.DashboardResponse previousDashboard = dashboards.dashboard(userId, previousMonth, DashboardFilter.BOTH);
